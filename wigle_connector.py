...
class WigleConnector(BaseConnector):

    def __init__(self):

        # Call the BaseConnectors init first
        super(WigleConnector, self).__init__()
    ...
    def _process_json_response(self, r, action_result):
        ...
        # The server returns a text with the content type set to JSON
    ...
    def _make_rest_call(self, endpoint, action_result, headers=None, params=None, data=None, method="get"):
        ...
        try:
            r = request_func(
                            url,
                            auth=(config['api_name'], config['api_token']),  # basic authentication
                            data=data,
                            headers=headers,
                            params=params)
        except Exception as e:
    ...
    def _handle_lookup_network(self, param):
        ...
        try:
            summary['next_page_token'] = response['search_after']
        except:
            pass

        try:
            summary['first'] = response['first']
        except:
            pass

        try:
            summary['last'] = response['last']
        except:
            pass

        try:
            summary['result_count'] = response['resultCount']
        except:
            pass

        results = response.get('results', [])

        for curr_item in results:
    ...
    def handle_action(self, param):
        ...
        elif action_id == 'lookup_network':
            ret_val = self._handle_lookup_network(param)
